...
var newOscillator = function newOscillator(frequency, oscId) {
...
var Voice = function () {
  function Voice(frequency) {
    var oscId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
    ...
    this.oscs = [];
    var baseFreq = frequency * this.opt.octave * this.opt.detune;
    var unisonSpread = 2;
    // Create unisons
    if (this.opt.unison > 1) {
      var minFreq = unisonSpread / 2 * -1;
      var inc = unisonSpread / (this.opt.unison - 1);
      for (var i = 0; i < this.opt.unison; i++) {
        var uFreq = minFreq + i * inc;
        var o = newOscillator(baseFreq + uFreq, oscId);
      ...
      var _o = newOscillator(baseFreq, oscId);
      this.tremGain.connect(_o.frequency);
      _o.connect(this.fenv);
      _o.start();
      this.oscs.push(_o);
    }
  ...
  _createClass(Voice, [{
    ...
    value: function release() {
      ...
      setTimeout(function () {
        // this.osc.stop()
        // this.osc.disconnect()
        _this.oscs.forEach(function (o) {
          o.stop();
          o.disconnect();
        });
        _this.fenv.disconnect();
        _this.env.disconnect();
        _this.pan.disconnect();
        _this.tremOsc.stop();
        _this.filterTremOsc.stop();
        _this.tremOsc.disconnect();
        _this.tremGain.disconnect();
        _this.filterTremOsc.disconnect();
        _this.filterTremGain.disconnect();
...
var frequencyFromNum = function frequencyFromNum(note) {
  return 440 * Math.pow(2, (note - 69) / 12);
};

// Plays a note
var playNote = function playNote(note, frequency) {
...
// Release a note
var stopNote = function stopNote(note, frequency) {
  if (osc1[note] && osc1[note].length > 0) {
    var voice = osc1[note].shift();
    voice.release();
  }
  if (osc2[note] && osc2[note].length > 0) {
    var _voice = osc2[note].shift();
    _voice.release();
  }
};

var setOscVolume = function setOscVolume(value) {
  var osc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
...
var setOscDetune = function setOscDetune(value) {
  var osc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

  oscOptions[osc].detune = value;
};

var setOscOctave = function setOscOctave(value) {
  var osc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

  oscOptions[osc].octave = value;
};

var setOscWaveform = function setOscWaveform(value) {
  var osc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

  oscOptions[osc].type = value;
};

var setOscUnison = function setOscUnison(value) {
  var osc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

  oscOptions[osc].unison = value;
};

var setOscPan = function setOscPan(value) {
  var osc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

  oscOptions[osc].pan = value;
};

var setOscTremoloWaveform = function setOscTremoloWaveform(value) {
  var osc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

  oscOptions[osc].tremWaveform = value;
};

var setOscTremoloAmp = function setOscTremoloAmp(value) {
  var osc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

  oscOptions[osc].tremAmp = value;
};

var setOscTremoloFreq = function setOscTremoloFreq(value) {
  var osc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

  oscOptions[osc].tremFreq = value;
};

var setOscEnvelopeAttack = function setOscEnvelopeAttack(value) {
  var osc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

  oscOptions[osc].attack = value;
};

var setOscEnvelopeDecay = function setOscEnvelopeDecay(value) {
  var osc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

  oscOptions[osc].decay = value;
};

var setOscEnvelopeSustain = function setOscEnvelopeSustain(value) {
  var osc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

  oscOptions[osc].sustain = value;
};

var setOscEnvelopeRelease = function setOscEnvelopeRelease(value) {
  var osc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

  oscOptions[osc].release = value;
};

var setFilterFreq = function setFilterFreq(value) {
  filterOptions.freq = value;
};

var setFilterQ = function setFilterQ(value) {
  filterOptions.q = value;
};

var setFilterEnv = function setFilterEnv(value) {
  filterOptions.env = value;
};

var setFilterTremoloWaveform = function setFilterTremoloWaveform(value) {
  filterOptions.tremWaveform = value;
};

var setFilterTremoloAmp = function setFilterTremoloAmp(value) {
  filterOptions.tremAmp = value;
};

var setFilterTremoloFreq = function setFilterTremoloFreq(value) {
  filterOptions.tremFreq = value;
};

var setFilterEnvelopeAttack = function setFilterEnvelopeAttack(value) {
  filterOptions.attack = value;
};

var setFilterEnvelopeDecay = function setFilterEnvelopeDecay(value) {
  filterOptions.decay = value;
};

var setFilterEnvelopeSustain = function setFilterEnvelopeSustain(value) {
  filterOptions.sustain = value;
};

var setFilterEnvelopeRelease = function setFilterEnvelopeRelease(value) {
  filterOptions.release = value;
};

var setGlobalVolume = function setGlobalVolume(value) {
  globalVolumeGain.gain.value = value;
};

var displayValues = function displayValues() {
  // console.log('filterOptions', filterOptions)
  // console.log('oscOptions', oscOptions)
};

module.exports = {
  setOscVolume: setOscVolume,
  setOscDetune: setOscDetune,
  setOscOctave: setOscOctave,
  setOscWaveform: setOscWaveform,
  setOscUnison: setOscUnison,
  setOscPan: setOscPan,
  setOscTremoloWaveform: setOscTremoloWaveform,
  setOscTremoloAmp: setOscTremoloAmp,
  setOscTremoloFreq: setOscTremoloFreq,
  setOscEnvelopeAttack: setOscEnvelopeAttack,
  setOscEnvelopeDecay: setOscEnvelopeDecay,
  setOscEnvelopeSustain: setOscEnvelopeSustain,
  setOscEnvelopeRelease: setOscEnvelopeRelease,
  setFilterFreq: setFilterFreq,
  setFilterQ: setFilterQ,
  setFilterEnv: setFilterEnv,
  setFilterTremoloWaveform: setFilterTremoloWaveform,
  setFilterTremoloAmp: setFilterTremoloAmp,
  setFilterTremoloFreq: setFilterTremoloFreq,
  setFilterEnvelopeAttack: setFilterEnvelopeAttack,
  setFilterEnvelopeDecay: setFilterEnvelopeDecay,
  setFilterEnvelopeSustain: setFilterEnvelopeSustain,
  setFilterEnvelopeRelease: setFilterEnvelopeRelease,
  playNote: playNote,
  stopNote: stopNote,
...
var QwertyHancock = __webpack_require__(23);
var synth = __webpack_require__(4);

// Helpers and templates
var patchTemplate = __webpack_require__(24);
var patchPublicTemplate = __webpack_require__(40);
var setPatchInfo = __webpack_require__(41);
var hide = function hide(b) {
  return b.addClass('hidden');
};
var show = function show(b) {
  return b.removeClass('hidden');
};

// Buttons
var showSaveFormButton = $('#show-save-form-button');
var saveNewButton = $('#save-new-button');
var cancelSaveNewButton = $('#cancel-save-new-button');
var saveUpdateButton = $('#save-update-button');
var confirmSaveUpdateButton = $('#confirm-save-update-button');
var cancelSaveUpdateButton = $('#cancel-save-update-button');
var deleteButton = $('#delete-button');
var cancelDeleteButton = $('#cancel-delete-button');
var confirmDeleteButton = $('#confirm-delete-button');

// Inputs
var patchNameInput = $('#patch-name-input');
var patchPrivate = $('#patch-private');

// Display elements
var patchNameDisplay = $('#patch-name-display');
var confirmPatchActionDisplay = $('#confirm-patch-action-display');
var patchesBar = $('#patches-bar');
var patchesList = $('#patches-list');
var authErrorDisplay = $('#auth-error-display');
var patchesBarLoader = $('#patches-bar-loader');
...
var resetPatchSaveArea = function resetPatchSaveArea() {
...
var showSaveForm = function showSaveForm() {
...
var hideSaveForm = function hideSaveForm() {
  show(showSaveFormButton);
  show(patchNameDisplay);
  hide(saveNewButton);
  hide(patchNameInput);
...
var showUpdateConfirm = function showUpdateConfirm() {
...
var hideUpdateConfirm = function hideUpdateConfirm() {
  hide(confirmSaveUpdateButton);
  hide(cancelSaveUpdateButton);
  hide(confirmPatchActionDisplay);
...
var showPatchesBar = function showPatchesBar() {
  patchesBar.addClass('patches-popout');
};

var hidePatchesBar = function hidePatchesBar() {
  patchesBar.removeClass('patches-popout');
};

var showPatchesBarLoader = function showPatchesBarLoader() {
  show(patchesBarLoader);
};

var hidePatchesBarLoader = function hidePatchesBarLoader() {
  hide(patchesBarLoader);
};

var checkPatchOwnership = function checkPatchOwnership() {
...
var populatePatchesBar = function populatePatchesBar(patches) {
  patchesList.html('');
  ...
  if (store.user) {
    ...
    patchesHTML = patchTemplate({ myPatches: myPatches, pubPatches: pubPatches });
  } else {
    patchesHTML = patchPublicTemplate({ patches: patches });
  }
  patchesList.append(patchesHTML);
  $('.load-patch-button').on('click', function (e) {
    var parent = $(e.target).closest('.patch-item')[0];
    // console.log('parent:', parent)
    var id = parent.dataset.id;
    // console.log('id:', id)
    if (store.user) {
      api.showPatch(id).then(showPatchSuccess).then(function () {
        return $('#patches-bar').modal('hide');
      }).catch(showPatchError);
    } else {
      api.showPatchPublic(id).then(showPatchSuccess).then(function () {
        return $('#patches-bar').modal('hide');
      }).catch(showPatchError);
    }
  });
...
var loadPatch = function loadPatch() {
  patchNameDisplay.text(store.patch.name);
  setPatchInfo(store.patch);
  checkPatchOwnership();
};

var createPatchSuccess = function createPatchSuccess(res) {
...
var createPatchError = function createPatchError(res) {
  // console.log('createPatchError')
  // console.log(res)
  showError();
};

var updatePatchSuccess = function updatePatchSuccess(res) {
  // console.log('updatePatchSuccess')
  // console.log(res)
  hideUpdateConfirm();
};
var updatePatchError = function updatePatchError(res) {
  // console.log('updatePatchError')
  // console.log(res)
  showError();
};

var indexPatchSuccess = function indexPatchSuccess(res) {
...
var indexPatchError = function indexPatchError(res) {
...
var showPatchSuccess = function showPatchSuccess(res) {
...
var showPatchError = function showPatchError(res) {
  // console.log('showPatchError')
  // console.log(res)
  showError();
};

var deletePatchSuccess = function deletePatchSuccess(res) {
  // console.log('deletePatchSuccess')
  // console.log(res)
  store.patch = null;
  resetPatchSaveArea();
};
var deletePatchError = function deletePatchError(res) {
...
var noteMapKeys = Object.keys(noteMap);
...
var setupKeyboard = function setupKeyboard() {
...
module.exports = {
  ...
  hideSaveForm: hideSaveForm,
  showUpdateConfirm: showUpdateConfirm,
  hideUpdateConfirm: hideUpdateConfirm,
  showDeleteConfirm: showDeleteConfirm,
  hideDeleteConfirm: hideDeleteConfirm,
  showPatchesBar: showPatchesBar,
  hidePatchesBar: hidePatchesBar,
  resetPatchSaveArea: resetPatchSaveArea,
  showPatchesBarLoader: showPatchesBarLoader,

  createPatchSuccess: createPatchSuccess,
  createPatchError: createPatchError,
  updatePatchSuccess: updatePatchSuccess,
  updatePatchError: updatePatchError,
  indexPatchSuccess: indexPatchSuccess,
  indexPatchError: indexPatchError,
  deletePatchSuccess: deletePatchSuccess,
  deletePatchError: deletePatchError,
  showError: showError,
...
var createPatch = function createPatch(data) {
  return $.ajax({
...
var updatePatch = function updatePatch(data) {
  return $.ajax({
...
var indexPatch = function indexPatch() {
  return $.ajax({
    url: config.apiOrigin + '/patches',
    method: 'GET',
    headers: {
...
var indexPatchPublic = function indexPatchPublic() {
  return $.ajax({
    url: config.apiOrigin + '/patches',
    method: 'GET'
  });
...
var showPatch = function showPatch(id) {
  return $.ajax({
...
var showPatchPublic = function showPatchPublic(id) {
  return $.ajax({
    url: config.apiOrigin + '/patches/' + id,
    method: 'GET'
  });
...
var deletePatch = function deletePatch(id) {
  return $.ajax({
    url: config.apiOrigin + '/patches/' + id,
    method: 'DELETE',
    headers: {
...
module.exports = {
  ...
  indexPatchPublic: indexPatchPublic,
  showPatch: showPatch,
  showPatchPublic: showPatchPublic,
...
var synth = __webpack_require__(4);
var authEvents = __webpack_require__(20);
var synthEvents = __webpack_require__(43);
var synthUi = __webpack_require__(6);
...
var standardKnobColor = 'rgb(120, 30, 255)';
var standardTextColor = 'rgb(200, 110, 255)';
var greenKnobColor = 'rgb(30, 200, 30)';
var greenTextColor = 'rgb(130, 255, 130)';
var blueKnobColor = 'rgb(20, 20, 230)';
var blueTextColor = 'rgb(100, 100, 255)';
var orangeKnobColor = 'rgb(200, 100, 30)';
var orangeTextColor = 'rgb(255, 127, 60)';
var redKnobColor = 'rgb(230, 20, 20)';
var redTextColor = 'rgb(255, 100, 100)';
...
};var bigKnob = Object.assign({
  width: 120,
  height: 120,
  thickness: 0.4
}, standardKnob);

var mediumKnob = Object.assign({
  width: 90,
  height: 90
}, standardKnob);

var smallKnob = Object.assign({
  width: 75,
  height: 75
}, standardKnob);

// Standard Attack Decay Release knob
var adrKnob = Object.assign({
  min: 0,
  max: 10,
  step: 0.05
}, smallKnob);
...
var _loop = function _loop(i) {
  ...
  $('#osc' + (i + 1) + '-volume').knob(Object.assign({
    change: function change(val) {
      return synth.setOscVolume(val / 100, i);
    },
  ...
  $('#osc' + (i + 1) + '-detune').knob(Object.assign({
    ...
    // step: 5,
    change: function change(val) {
      return synth.setOscDetune(2 ** (val / 1200), i);
    },
    release: function release(val) {
      return synth.setOscDetune(2 ** (val / 1200), i);
    }
  ...
  $('#osc' + (i + 1) + '-octave').knob(Object.assign({
    ...
    max: 2,
    release: function release(val) {
      return synth.setOscOctave(2 ** val, i);
    }
  }, mediumKnob, blueKnob));

  // Oscillator 1 second set of knobs
  $('#osc' + (i + 1) + '-waveform').on('change', function (e) {
    // console.log(e);
  ...
  $('#osc' + (i + 1) + '-unison').knob(Object.assign({
    ...
    max: 8,
    release: function release(val) {
      return synth.setOscUnison(val, i);
    }
  }, bigKnob, redKnob));
  ...
  // Osc1 tremolo
  $('#osc' + (i + 1) + '-trem-waveform').on('change', function (e) {
    // console.log(e);
  ...
  $('#osc' + (i + 1) + '-trem-amp').knob(Object.assign({
    ...
    max: 80,
    change: function change(val) {
      return synth.setOscTremoloAmp(val, i);
    },
    release: function release(val) {
      return synth.setOscTremoloAmp(val, i);
    }
  ...
  $('#osc' + (i + 1) + '-trem-freq').knob(Object.assign({
    ...
    step: 0.1,
    change: function change(val) {
      return synth.setOscTremoloFreq(val, i);
    },
    release: function release(val) {
      return synth.setOscTremoloFreq(val, i);
    }
  ...
  $('#osc' + (i + 1) + '-attack').knob(Object.assign({
    change: function change(val) {
      return synth.setOscEnvelopeAttack(val, i);
    },
    release: function release(val) {
      return synth.setOscEnvelopeAttack(val, i);
    }
  ...
  $('#osc' + (i + 1) + '-decay').knob(Object.assign({
    change: function change(val) {
      return synth.setOscEnvelopeDecay(val, i);
    },
    release: function release(val) {
      return synth.setOscEnvelopeDecay(val, i);
    }
  ...
  $('#osc' + (i + 1) + '-sustain').knob(Object.assign({
    ...
    step: 0.05,
    change: function change(val) {
      return synth.setOscEnvelopeSustain(val, i);
    },
    release: function release(val) {
      return synth.setOscEnvelopeSustain(val, i);
    }
  ...
  $('#osc' + (i + 1) + '-release').knob(Object.assign({
    change: function change(val) {
      return synth.setOscEnvelopeRelease(val, i);
    },
    release: function release(val) {
      return synth.setOscEnvelopeRelease(val, i);
    }
...
$('#filter-freq').knob(Object.assign({
  ...
  step: 100,
  change: function change(val) {
    return synth.setFilterFreq(val);
  },
  release: function release(val) {
    return synth.setFilterFreq(val);
  }
...
$('#filter-env').knob(Object.assign({
  ...
  step: 100,
  release: function release(val) {
    return synth.setFilterEnv(val);
  }
}, mediumKnob, blueKnob));

// Filter tremolo
$('#filter-trem-waveform').on('change', function (e) {
...
$('#filter-trem-amp').knob(Object.assign({
  ...
  step: 50,
  change: function change(val) {
    return synth.setFilterTremoloAmp(val, 0);
  },
  release: function release(val) {
    return synth.setFilterTremoloAmp(val, 0);
  }
...
$('#filter-trem-freq').knob(Object.assign({
  ...
  step: 0.1,
  change: function change(val) {
    return synth.setFilterTremoloFreq(val, 0);
  },
  release: function release(val) {
    return synth.setFilterTremoloFreq(val, 0);
  }
...
$('#global-volume').knob(Object.assign({
  ...
  height: 240,
  change: function change(val) {
    return synth.setGlobalVolume(val / 100);
  },
  release: function release(val) {
    return synth.setGlobalVolume(val / 100);
  }
...
var onSignUp = function onSignUp(e) {
  e.preventDefault();
  var data = getFormFields(document.getElementById('credentials-form'));
  ...
  }).then(ui.logInSuccess).catch(ui.signUpError);
};
...
var onLogIn = function onLogIn(e) {
  ...
  ui.showAuthLoader();
  // console.log('data:', data)
  api.logIn(data).then(ui.logInSuccess).catch(ui.logInError);
};
...
var onChangepwd = function onChangepwd(e) {
  e.preventDefault();
  var data = getFormFields(document.getElementById('changepwd-form'));
  ...
  ui.showAuthLoader();
  if (store.user) {
    api.changepwd(data).then(ui.changepwdSuccess).catch(ui.changepwdError);
  } else {
    // console.log('No user!')
    // console.log(store.user)
  }
...
var onShowChangepwdForm = function onShowChangepwdForm(e) {
  ui.showChangepwdForm();
};

var onCancelChangepwd = function onCancelChangepwd(e) {
...
var changepwdButton = $('#changepwd-button');

// Forms
var credentialsForm = $('#credentials-form');
var changepwdForm = $('#changepwd-form');

// UI hide / show buttons
var showChangepwdButton = $('#show-changepwd-button');
var cancelChangepwdButton = $('#cancel-changepwd-button');

// Displays
var authErrorDisplay = $('#auth-error-display');
var authLoader = $('#auth-loader');

var resetAuthArea = function resetAuthArea() {
  show(signupButton);
  show(loginButton);
...
var signUpError = function signUpError(res) {
...
var logInError = function logInError(res) {
...
var signOutError = function signOutError(res) {
  // console.log('signOutError')
  // console.log(res)
};

var changepwdSuccess = function changepwdSuccess(res) {
  // console.log('changepwdSuccess')
  hideChangepwdForm();
  changepwdForm.children('input').val('');
  hideAuthLoader();
};
var changepwdError = function changepwdError(res) {
...
var showChangepwdForm = function showChangepwdForm() {
  show(changepwdForm);
...
var hideChangepwdForm = function hideChangepwdForm() {
  hide(changepwdForm);
  hide(changepwdButton);
  hide(cancelChangepwdButton);
  show(showChangepwdButton);
...
module.exports = {
  ...
  showChangepwdForm: showChangepwdForm,
  hideChangepwdForm: hideChangepwdForm,
  showError: showError,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.myPatches : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "    <div data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"patch-item private\">\n      <h4>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</h4>\n      <button class=\"btn btn-block btn-out btn-fade btn-green load-patch-button private\">Load this patch</button>\n    </div>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "  <h3>You don't have any patches!<br />Maybe you should make one?</h3>\n  <hr />\n";
},"6":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.pubPatches : depth0),{"name":"each","hash":{},"fn":container.program(7, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
  ...
  return "    <div data-id=\""
    ...
    + "\" class=\"patch-item\">\n      <h4>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "</h4>\n      <button class=\"btn btn-block btn-out btn-fade btn-green load-patch-button\">Load this patch</button>\n    </div>\n";
},"9":function(container,depth0,helpers,partials,data) {
    return "  <h3>No patches found.</h3>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {});

  return "<h3>My patches</h3>\n<hr />\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = (depth0 != null ? depth0.myPatches : depth0)) != null ? stack1.length : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "<h3>Public patches</h3>\n<hr />\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = (depth0 != null ? depth0.pubPatches : depth0)) != null ? stack1.length : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(9, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.patches : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;
  ...
  return "    <div data-id=\""
    ...
    return "  <h3>No patches found. <br />Maybe you should make one?</h3>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.patches : depth0)) != null ? stack1.length : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
var store = __webpack_require__(2);
var getPatchInfo = __webpack_require__(44);
var api = __webpack_require__(9);
var ui = __webpack_require__(6);

var onCreatePatch = function onCreatePatch(e) {
  e.preventDefault();
  var data = getPatchInfo(true);
  if (!data.patch.name) {
  ...
  // console.log(data)
  if (store.user) {
    api.createPatch(data).then(ui.createPatchSuccess).catch(ui.createPatchError);
  } else {
    // console.log('No user!')
    // console.log(store.user)
  }
...
var onUpdatePatch = function onUpdatePatch(e) {
  e.preventDefault();
  var data = getPatchInfo(true);
  // console.log(data)
  if (store.user && store.patch) {
    delete data.patch.name;
    api.updatePatch(data).then(ui.updatePatchSuccess).catch(ui.updatePatchError);
  } else {
...
var onDeletePatch = function onDeletePatch(e) {
  e.preventDefault();
  if (store.user && store.patch) {
    api.deletePatch(store.patch.id).then(ui.deletePatchSuccess).catch(ui.deletePatchError);
  } else {
    // console.log('No user (maybe?!)')
    // console.log(store.user)
    // console.log('No patch (maybe?!)')
...
var onIndexPatch = function onIndexPatch(e) {
  // e.preventDefault()
  ui.showPatchesBarLoader();
  if (store.user) {
    api.indexPatch().then(ui.indexPatchSuccess).catch(ui.indexPatchError);
  } else {
    api.indexPatchPublic().then(ui.indexPatchSuccess).catch(ui.indexPatchError);
  }
};
...
var SimpleMidiInput = __webpack_require__(46);
var synth = __webpack_require__(4);
...
var logMidiInputs = function logMidiInputs() {
  // console.log('easymidi.getInputs()')
  // console.log(easymidi.getInputs())
};

module.exports = {
  logMidiInputs: logMidiInputs
};
...
var MidiLearn = __webpack_require__(48);
...
var MidiLearning = __webpack_require__(49);
